...
public class AttendenceStudentResourceIT {
  ...
  public void initTest() {
    ...
    au2.setName(AuthoritiesConstants.USER);
    tempUser.setAuthorities(new HashSet<Authority>(Arrays.asList(au2, au1)));
  ...
  public void createAttendenceStudent() throws Exception {
    ...
    AttendenceStudentDTO attendenceStudentDTO = attendenceStudentMapper.toDto(attendenceStudent);
  ...
  public void takeAttendenceStudent() throws  Exception{
    ...
    restAttendenceStudentMockMvc.perform(post("/api/takeAttendence-student")
        ...
        .accept(MediaType.APPLICATION_JSON)).andDo(MockMvcResultHandlers.print()).andExpect(status().isCreated());
