...
public class LoginResourcesTest {
	...
	public void post_authenticate_user_returnJwt() throws Exception{
		...
		final String jwtToken="eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhYmNAZ21haWwuY29tIiwiZXhwIjoxNTk3MjY3OTgyLCJpYXQiOjE1OTcyMzE5ODJ9.XynUqR0QcnJ9liME-Ct2LyBWqZHYfv77HBRHMwXYmFM";
		...
		Mockito.when(jwtUtil.generateToken(Mockito.anyString()))
			.thenReturn(jwtToken);
